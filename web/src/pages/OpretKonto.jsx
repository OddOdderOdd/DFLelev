...
export default function OpretKonto() {
  ...
  const [form, setForm] = useState({
    navn: '', kaldenavn: '', email: '', telefon: '', kode: '', gentag_kode: '',
      ...
      <div className="max-w-2xl mx-auto space-y-5">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6">
          ...
          <div className="grid gap-2">
            ...
            <input value={profilForm.telefon} onChange={e => setProfilForm(prev => ({ ...prev, telefon: e.target.value }))} className="border rounded-xl px-3 py-2 text-sm" placeholder="Telefon" />
          </div>
        ...
        <form onSubmit={indsend} className="space-y-6">
          ...
          <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
            ...
            <div className="mb-4">
              ...
              <input type="text" value={form.telefon} onChange={e => sætFelt('telefon', e.target.value)}
