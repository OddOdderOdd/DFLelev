        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Fælles undervisningsmaterialer, skabeloner og guides.
            </p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2 rounded-xl border border-slate-300 bg-white/80 backdrop-blur-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm"
                />
              ...
              <select
                ...
                className="sm:w-52 px-3 py-2 rounded-xl border border-slate-300 bg-white/80 backdrop-blur-sm shadow-sm text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
              >
        ...
        {showInfo && (
          <div className="mb-6 bg-white/80 backdrop-blur border border-slate-200 rounded-2xl p-4 shadow-sm">
            {isStatsLoading || !stats ? (
              <p className="text-sm text-slate-500">Indlæser overblik over ressourcer...</p>
            ) : (
            ...
            <p className="text-gray-500 mb-6">
              {searchQuery
                ...
                : isAdmin
                  ...
                  : 'Der er ingen ressourcer-kasser tilgængelige'}
            </p>
          </div>
        ) : (
                  ...
                  {isAdmin && (
                    <div className="flex gap-2 pt-3 border-t border-gray-200">
                      <button
                        ...
                        className="flex-1 text-sm bg-slate-100 hover:bg-slate-200 text-slate-700 px-3 py-2 rounded transition-colors"
                        title="Nøgle & adgang"
                      >
                        🔑 Adgang
                      </button>
