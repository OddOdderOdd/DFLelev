  ...
  const menuItems = [
    {
      ...
      icon: bruger ? '🪪' : '👤',
      beskrivelse: bruger ? 'Se og rediger dine profiloplysninger' : 'Opret en ny brugerkonto',
      vis: true,
    ...
    },
    {
      ...
      label: 'Log',
      icon: '📋',
      beskrivelse: 'Røde flag, bruger-log og systemaktivitet',
    ...
    },
    {
      ...
      label: 'Verify',
      icon: '✅',
      beskrivelse: 'Godkend nye konti og anmodninger',
